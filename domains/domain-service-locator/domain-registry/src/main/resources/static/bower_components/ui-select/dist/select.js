 ...
 *
 * See jqLite.find - why not use querySelectorAll? https://github.com/angular/angular.static/issues/3586
 * See feat(jqLite): use querySelectorAll instead of getElementsByTagName in jqLite.find https://github.com/angular/angular.static/pull/3598
 */
 ...
 * See https://github.com/angular-ui/bootstrap/blob/0.10.0/src/typeahead/typeahead.static#L340
 */
 ...
 * See https://github.com/angular-ui/bootstrap/blob/master/src/position/position.static#L70
 */
.factory('uisOffset',
  ['$document', '$window',
  ...
  return {
    ...
    compile: function(tElement, tAttrs) {
      ...
      return function(scope, element, attrs, ctrls, transcludeFn) {
        ...
        // Move transcluded elements to their correct position in main templates
 ...
 * See https://github.com/angular/angular.static/blob/v1.2.15/src/ng/directive/ngRepeat.static#L211
 *
